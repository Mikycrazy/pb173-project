...
int Client::login()
{
    ...
    int packetSize = this->packetCreator(LOGIN_REQUEST,data,&packet,dataSize);
...
int Client::logout()
{
    ...
    unsigned char *packet = NULL;
    int packetSize = this->packetCreator(LOGOUT_REQUEST,data,&packet,dataSize);
...
int Client::packetCreator(unsigned char id, unsigned char *data, unsigned char **packet, int size)
{
